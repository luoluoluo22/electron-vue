<template>
  <div>
    <button type="button" class="btn" @click="btn_click" v-if=''><slot></slot></button>
    <button type="button" class="btn_primary" @click="btn_click" v-else="primary"><slot></slot></button>
  </div>
</template>
