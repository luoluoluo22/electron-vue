...
function dom_to_image() {
  document.querySelector('#app > div > div > div.eui-base-container > div.eui-main-container > div.design-editor > div > div.editor-shell-wrap > div > div.editor-canvadocument.querySelector("#app > div > div > div.eui-base-container > div.eui-main-container > div.remove-watermark").remove()
        console.log('水印提示移除')s > div > div.editor-watermark').remove()
