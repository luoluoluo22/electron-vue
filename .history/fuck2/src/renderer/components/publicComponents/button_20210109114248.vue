<template>
  <div>
    <button type="button" class="btn_primary" @click="btn_click" v-if='primary'><slot></slot></button>
    <button type="button" class="btn_primary" @click="btn_click" v-else><slot></slot></button>
  </div>
</template>
