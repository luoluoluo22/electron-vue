  ...
  export default {
    ...
    methods: {
      ...
      mounted: function () {
        ...
        this.$options.data.template_banner_src = ['https://st0.dancf.com/02/material_uploader/202012090935-5379.jpg', 'https://st0.dancf.com/02/material_uploader/202012090935-5379.jpg']
        console.log('数据')
      }
