...
<script>
const axiso = require('axiso')
export default {
  data () {
    return {
      name: 'side-bar',

      template_banner_src: ['../images/bg_images/bg_1.jpg'],
  ...
  methods: {
    ...
    get_bg_url: function(page_num = '1') {
      return new Promise(resolve => {
        axios({
          method: 'get',
          url: `https://search-v2.hlgdata.com/gd_web/editor/material?page_num=${page_num}&page_size=40&filter_id=1610349&region_id=1&biz_code=1&endpoint=4&is_free=&from_site=gaoding`
        }).then((res) => {
