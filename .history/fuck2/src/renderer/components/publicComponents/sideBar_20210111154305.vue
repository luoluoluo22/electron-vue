<template>
  ...
  <!-- 左侧_导航栏 声明式导航 -->
    <div id='left'>
      ...
      <router-link to='/' tag='i' class="iconfont icon-background" active-class='active_sider'></router-link>
      <router-link to='/' tag='i' class="iconfont icon-ai247" active-class='active_sider'></router-link>
      <router-link to='/' tag='i' class="iconfont icon-seban" active-class='active_sider'></router-link>
      <i class="iconfont icon-template-library"></i>
      <i class="iconfont icon-template-background"></i>
      <i class="iconfont icon-template-ai247"></i>
      <i class="iconfont icon-template-seban"></i>
    </div>
