...
export default {
   ...
   methods: {
     set_img_src: function(url) {
       headers: {'yl-authorization': Mozilla/5.0 (Macintosh; Intel Mac OS X 11_1_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Safari/537.36}// 设置header信息
