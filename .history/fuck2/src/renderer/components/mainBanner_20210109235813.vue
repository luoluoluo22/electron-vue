...
<script>
  ...
  export default {
    data () {
      return {
        src_list: ['https://st0.dancf.com/02/material_uploader/202012090935-5379.jpg']
      }
    },
    ...
    methods: {
      ...
      update_bg_urls: async function() {
        this.src_list = await this.$options.methods.get_bg_url();// 获取test()函数的返回值
        console.log(`已执行更新背景`)
      },
      test() {
         thisupdate_bg_urls
    ...
    mounted: function () {
      ...
      this.src_list = ['https://st0.dancf.com/02/material_uploader/202012090935-5379.jpg', 'https://st0.dancf.com/02/material_uploader/202012090935-5379.jpg']
      console.log('数据')
    }
  }
</script>
