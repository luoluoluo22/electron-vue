  ...
  methods: {
    ...
    get_bg_url: function(pageNum = '1') {
      return new Promise(resolve => {
        axios.get(https://search-v2.hlgdata.com/gd_web/editor/material?page_num=${pageNum}&page_size=40&filter_id=1610349&region_id=1&biz_code=1&endpoint=4&is_free=&from_site=gaoding`
        }).then((res) => {
