...
// 点击放大
let add=
document.querySelector('#app > div > div > div.eui-base-container > div.eui-main-container > div.editor-bottom > div.eui-editor-tool-bar > div > button:nth-child(3)').click()
document.querySelector('#app > div > div > div.eui-base-container > div.eui-main-container > div.editor-bottom > div.eui-editor-tool-bar > div > button:nth-child(1)').click()
function screenshot() {
  let num = document.querySelector('#app > div > div > div.eui-base-container > div.eui-main-container > div.editor-bottom > div.eui-editor-tool-bar > div > button.eui-button.eui-editor-tool-bar-btn.eui-editor-tool-bar__zoom-button.eui-button--with-tooltip.eui-button--normal--clear.eui-button__icon--only.eui-button--middle > div.eui-button__container').textContent.trim()
  if (num === '50%') {
    return true
  } else {
    return true
