...
export default {
  ...
  data () {
    return {
      ...
      pageNum:1,
      url: `https://search-v2.hlgdata.com/gd_web/editor/material?page_num=${thispageNum}&page_size=40&filter_id=1610349&region_id=1&biz_code=1&endpoint=4&is_free=&from_site=gaoding`
  },
